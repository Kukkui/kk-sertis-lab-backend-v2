...
| localhost:5000/posts/all  | POST | - | list all post from anyone with JSON output. Fetch from mysql online instead of local mysql| 
| localhost:5000/posts/me | POST | - | list all posts that own by current authenticated user |
...
<b>POST localhost:5000/posts/all <= {} </b><br/><br/>
<hr/><br/>
<img src="./screenshots/mypost.gif" width="100%" /><br/>
<b>POST localhost:5000/posts/me <= {} </b><br/><br/>
<hr/><br/>
